...
const CuisinePaginator = () => {
  ...
  useEffect(() => {
    getPaginatedCuisineList();
  }, [CuisinePerPage, CuisineFilter, CuisinePage]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    <div className="card m-0 p-1">
        <Paginator
          ...
          rows={CuisinePerPage}
          totalRecords={CuisineTotalRecords}
