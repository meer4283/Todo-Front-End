...
const VendorsPaginator = () => {
  ...
  useEffect(() => {
    getPaginatedVendorsList();
  }, [VendorsPerPage, VendorsFilter, VendorsPage]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    <div className="card m-0 p-1">
        <Paginator
          ...
          rows={VendorsPerPage}
          totalRecords={VendorsTotalRecords}
